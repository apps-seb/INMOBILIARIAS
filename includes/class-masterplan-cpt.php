...
?>
    ...
    public function render_poi_details_metabox($post)
    {
        ...
        $poi_style = get_post_meta($post->ID, '_poi_style', true);
...
?>
        <table class="form-table">
            ...
            <tr>
                <th><label for="poi_style">Estilo del Pin</label></th>
                <td>
                    <select id="poi_style" name="poi_style">
                        <option value="default" <?php selected($poi_style, 'default'); ?>>📍 Estándar</option>
                        <option value="orthogonal-label" <?php selected($poi_style, 'orthogonal-label'); ?>>🏷️ Ortogonal con Etiqueta</option>
                        <option value="orthogonal" <?php selected($poi_style, 'orthogonal'); ?>>📏 Línea Ortogonal con Logo</option>
                        <option value="gold" <?php selected($poi_style, 'gold'); ?>>🏆 Icono 3D Dorado</option>
                        <option value="flag" <?php selected($poi_style, 'flag'); ?>>🚩 Bandera</option>
                    </select>
                </td>
            </tr>
            <tr>
...
?>
    ...
    public function save_meta_boxes($post_id)
    {
        ...
        if ($post_type === 'masterplan_poi') {
            ...
            if (isset($_POST['poi_style'])) {
                update_post_meta($post_id, '_poi_style', sanitize_text_field($_POST['poi_style']));
            }
